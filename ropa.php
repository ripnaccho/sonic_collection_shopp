...
$productos = [
    ['id' => 2, 'nombre' => 'Remera Sonic', 'precio' => 3500, 'imagen' => 'img/remera1.png'],
  
];

// Inicializo carrito si no existe
...
<body>
  <h2 style="text-align:center">Sección: Ropa</h2>
